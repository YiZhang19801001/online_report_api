...
class PosReportHelper
{
    ...
    public function makeReport($shop, $startDate, $endDate)
    {
        ...
        return ['totalSales' => $totalSales, 'totalTx' => $sql->count(), 'shop' => $shop, 'gp' => $sqlResult->gp, 'discount' => $sqlResult->discount, 'gp_percentage' => $sqlResult->gp / $totalSales == 0 ? 1 : $totalSales, 'totalRefund' => $totalRefund];
